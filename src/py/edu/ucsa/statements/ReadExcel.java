...
public class ReadExcel {
    ...
    public static void main(String[] args) {
        try {
            ...
            Connection conSource = Conexiones.obtenerConexion(Conexiones.DBMS_TYPE_ODBC_EXCEL);
            ...
            int count = 1; 
            while(rs.next()){
                System.out.println("Nº Orden Resultado: " + (count++));
                ...
                System.out.println("Telefono:  "+ rs.getString("Teléfono"));
                System.out.println("*********************************************");
            }
            conSource.close();
