...
public class FrmViewPersonas 
{
	...
	private void createAndShowGUI()
	{
		...
		frame = new JFrame("Vista Personas");
	...
	public void buscarTabla()
	{
		...
		while (contador < datosProductos.length)
		{
			...
			else if (datosProductos[contador][3].matches(textoABuscar) == true)
			{
				modelo.addRow(datosProductos[contador]);
			}
			else if (datosProductos[contador][4].matches(textoABuscar) == true)
			{
				modelo.addRow(datosProductos[contador]);
			}
